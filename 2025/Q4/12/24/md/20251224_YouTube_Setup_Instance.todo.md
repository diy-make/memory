# WeDo: YouTube Account Management Setup (Wish List)
...
**Project Status: Wish List**
This project is currently on the wish list and is awaiting further prioritization and user interaction for OAuth2 completion.
...
## Tasks
- [x] WeDo: YTA-SEC-01 | Secure API Credentials
  - ID: YTA-SEC-01
  - Status: [x]
  - Description: Verify presence of `client_secret.json` or equivalent in the filesystem. (DONE: Copied from reality-merge)
